...
**GitHub Repository:**
https://github.com/GURRALASAIHANEESH/trading_bot
...
**Subject:**
```
Application - Python Developer (Trading Bot) - Gurrala Sai Haneesh
```
...
Please find my submission for the Python Developer assessment task.

GitHub: https://github.com/GURRALASAIHANEESH/trading_bot

Both MARKET and LIMIT orders were placed successfully on the
Binance Futures Demo environment (demo-fapi.binance.com).
Log files are included in the repository under logs/trading_bot.log.

Note: The task specifies testnet.binancefuture.com, which Binance has
since migrated to demo-fapi.binance.com. The implementation uses the
current official demo endpoint, which is functionally identical.

Happy to discuss the implementation in an interview.
